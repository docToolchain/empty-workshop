...
TIP: das draw.io Plugin ist in der Codespaces-Umgebung schon vorinstalliert.
...
WARNING: Dieser Schritt funktioniert momentan nur unter Windows
...
Nimm ein Foto von einem Diagramm und weise Deinen KI Assistenten an, das Diagramm als PlantUML nachzubauen.

.Diagramm von c4model.com
image::https://c4model.com/images/sketch-2.jpg[]
