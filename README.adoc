...
In Github Codespaces there will be a web based visual studio instance with everything pre-installed.
...
For a step-by-step workshop tutorial (arc42 + linter + dacli + b11t) open xref:src/docs/workshop-tooling-tutorial.adoc[]
...
Codespaces will now ask you what to do with the opened port. Just click on "open in browser" and navigate through the `build` folder.
